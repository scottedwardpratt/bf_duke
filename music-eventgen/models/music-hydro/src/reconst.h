...
class Reconst {
 ...
 public:
    ...
    int solve_v_Hybrid(const double v_guess, const double T00, const double M,
		     const double J0, const double proper_tau, double &v_solution);
    ...
    int solve_u0_Hybrid(const double u0_guess, const double T00, const double K00,
			const double M, const double J0, const double proper_tau,
			double &u0_solution);
