...
double EOS_eosQ::p_e_func(double e, double rhob, double proper_tau) const {
    return(get_dpOverde3(e, rhob, proper_tau));
}


double EOS_eosQ::p_rho_func(double e, double rhob, double proper_tau) const {
...
double EOS_eosQ::get_temperature(double e, double rhob, double proper_tau) const {
...
double EOS_eosQ::get_pressure(double e, double rhob, double proper_tau) const {
    int table_idx = get_table_idx(e);
...
//! input local energy density eps [1/fm^4] and rhob [1/fm^3]
double EOS_eosQ::get_mu(double e, double rhob, double proper_tau) const {
    int table_idx = get_table_idx(e);
...
double EOS_eosQ::get_s2e(double s, double rhob, double proper_tau) const {
