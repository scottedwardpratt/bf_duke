...
TEST_CASE("test speed of sound squared") {
    ...
    EOS_idealgas test;
    CHECK(test.get_cs2(1.0, 1.0, 0.0)  == 1./3.);
    CHECK(test.get_cs2(2.0, 1.0, 0.0)  == 1./3.);
    CHECK(test.get_cs2(1.0, -1.0, 0.0) == 1./3.);
}
...
TEST_CASE("test dPde") {
    // dPdrho = 1/3.
    EOS_idealgas test;
    CHECK(test.p_e_func(1.0, 1.0, 0.0)  == 1./3.);
    CHECK(test.p_e_func(2.0, 1.0, 0.0)  == 1./3.);
    CHECK(test.p_e_func(1.0, -1.0, 0.0) == 1./3.);
}
...
TEST_CASE("test pressure") {
    // P = e/3.
    EOS_idealgas test;
    CHECK(test.get_pressure(1.0, 1.0, 0.0)  == 1./3.);
    CHECK(test.get_pressure(2.0, 1.0, 0.0)  == 2./3.);
    CHECK(test.get_pressure(1.0, -1.0, 0.0) == 1./3.);
}
