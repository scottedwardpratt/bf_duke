...
double EOS_WB::get_cs2(double e, double rhob, double proper_tau) const {
    double f = calculate_velocity_of_sound_sq(e, rhob, proper_tau);
    return(f);
}
    

double EOS_WB::p_e_func(double e_local, double rhob, double proper_tau) const {
    double cs2_local;
    double e1 = e_local;
	double e2 = e1*e1;
	double e3 = e2*e1;
...
double EOS_WB::get_temperature(double e_local, double rhob, double proper_tau) const {
    double temperature;
    double e1 = e_local;
	double e2 = e1*e1;
	double e3 = e2*e1;
...
double EOS_WB::get_pressure(double e_local, double rhob, double proper_tau) const {
    double p;
    double e1 = e_local;
...
double EOS_WB::get_s2e(double s, double rhob, double proper_tau) const {
