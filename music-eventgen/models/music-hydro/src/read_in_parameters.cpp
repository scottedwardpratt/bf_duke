...
InitData read_in_parameters(std::string input_file) {
    ...
    // Initial quark fugacities
    double tempfug_l_0 = 0;
    tempinput = Util::StringFind4(input_file, "Initial_light_quark_fugacity");
    if (tempinput != "empty")
        istringstream(tempinput) >> tempfug_l_0;
    parameter_list.fug_l_0 = tempfug_l_0;

    double tempfug_s_0 = 0;
    tempinput = Util::StringFind4(input_file, "Initial_strange_quark_fugacity");
    if (tempinput != "empty")
        istringstream(tempinput) >> tempfug_s_0;
    parameter_list.fug_s_0 = tempfug_s_0;
